...
\webbox{
\webhead{Vorlage Demo, 10 Funktionen2}{Formatierte Hallo-Welt-Ausgabe}
...
/// Formatierte Hallo-Welt-Ausgabe
//  Anwendungsbeispiel für die Befehlsreferenz
~Include HalloWelt3 weltindex=1; weltbezeichnung=Meine Welt
\end{verbatim}
...
Das obige Beispiel wird wie folgt angezeigt:
\webbox{
\webhead{Vorlage Demo, 13 Schleifen}{Formatierte Hallo-Welt-Ausgabe}
Wie soll Meine Welt begrüßt werden?
\begin{circlist}
\item Mit \dq Hallo\dq
\item Mit \dq Guten Morgen\dq
...
\webbox{
\webhead{Vorlage Demo, 14 HalloFehler}{Fehler-Beispiel}
