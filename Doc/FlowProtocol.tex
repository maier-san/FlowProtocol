...
Die Form der Anleitung bietet sich besonders dann an, wenn die Erweiterung nach einem bestimmten Muster verläuft und selbst wieder Artefakte verwendet, die sichgut  mit \FlowProtocol-Vorlagen bereiststellen lassem, wie der Aufruf von URLs, um Werte nachzuschlagen.
\end{document}