...
>> Die Zahl $w ist
    ...
    > $p
\end{verbatim}
Das obige Beispiel fragt eine Zahl zwischen 0 und 10 ab und bestimmt anhand von zwei Bedingungen Eigenschaften, die nachfolgend ausgegeben werden. 
...
\FehlerBeschreibungItem{C15}{Die Listendatei $\dots$ konnte nicht gefunden werden.} Tritt auf, wenn beim Fragelisten-Befehl \verb|~ForEach| (siehe Abschnitt~\ref{Fragelisten}) die angegebene Fragedatei nicht gefunden werden kann. 
